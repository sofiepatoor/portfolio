...
About a year ago, I came across this [video about "creating a digital garden"](https://youtu.be/0tY7Z53QJo8?si=T5fgSskpheru6ecp) by Anna Howard. I wouldn't do it justice by trying to summarize it in a few sentences, but she talks about keeping a "digital garden" for mindful media consumption, with tools like Obsidian or Notion. 

This [article by Maggie Appleton](https://maggieappleton.com/garden-history) explains the general concept really well:
...
If this kind of stuff interests you, I *really* recommend reading through this beautiful and interesting website by Henry From Online, ["A website to destroy all websites"](https://henry.codes/writing/a-website-to-destroy-all-websites/#where-do-we-go-from-here). In it, he writes:
...
<!-- However, if you've worked at the same company for a while or you've used the same tech stack over the years, you might end up in a bit of a comfort zone, which sounds contradictory to the impostor syndrome I've just mentioned. You're still aware of the (growing) gaps in your skillset, but you *are* pretty experienced in your particular area. -->
